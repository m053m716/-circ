...
%MEDTEST Tests for significance of the median.
%
% pval = circ.medtest(alpha,md)
%   Tests for significance of the median.
%   --> H_0: the population has median angle md
%   --> H_A: the population has not median angle md
%
%   Input:
