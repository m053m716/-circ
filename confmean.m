...
%CONFMEAN  Computes the confidence limits on the mean for circular data.
%
% t = circ.confmean(alpha, xi, w, d, dim)
...
for i = 1:numel(r)
  ...
  elseif r(i) >= .9
    ...
    t(i) = NaN;
    warning('CIRC:CONFMEAN:R_TOO_SMALL', 'Requirements for confidence levels not met.');
  end
end
